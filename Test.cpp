	...
	{	
		...
		/*double xbest=338.397;
		double ybest=487.356;
		double zbest=1050.43; */
		
		best_pose->object_value=-1;
		//best_pose->origin->px=-1;
		//best_pose->origin->py=-1;
		//best_pose->origin->pz=-1;
		...
		while(trasliteration<50){
			trasliteration++;
			//std::cout<<trasliteration<<std::endl;
			//if(best_pose->object_value>0)
			  //traslcounter++;
			/*if(best_pose->object_value>0){
				//traslcounter=0;
				if(k.loc_h_>2){
					k.loc_h_=k.loc_h_-alpha;
				}
			}*/
			...
			//std::cout<<best_pose->object_value<<std::endl;
			...
			//std::cout<<xbest<<" "<<ybest<<" "<<zbest<<std::endl;
			...
			while(iter!= model->faces.end()){
				...
				*face=*iter;
				...
				piano=face->getPiano(model->vertexes,*face);
				iter->piano=*piano;
		...
		while(extiteration<100){
			...
			//}
			//std::cout<<lmin_detector<<std::endl;
	...
	*/
			...
			//std::cout<<size<<std::endl;//prin the number of points in the range file
			...
			while(iter2!=translations.end()){
				//std::cout<<iter2->object_value<<std::endl;
				//std::cout<<"pose x="<<iter2->origin->px<<"y="<<iter2->origin->py<<"z="<<iter2->origin->pz<<" "<<iter2->object_value<<std::endl;
				//std::cout<<"orientation"<<iter2->orientation[0]<<" "<<iter2->orientation[1]<<" "<<iter2->orientation[2]<<std::endl;
